...
import { ABOUT_STATS, VALUES, STAGES, MARKETS } from '@/lib/site-data';

export const metadata: Metadata = {
  title: 'About',
  description: 'Why BuildSprint exists: a product-first team that takes companies from idea to launch in weeks, not months.',
};
  ...
  return (
    <>
      <section className="phero"><div className="wrap">
        ...
        <span className="kicker reveal d1" style={{ marginTop: 18 }}>About BuildSprint</span>
        <h1 className="reveal d1">From idea to launch in <span className="em">weeks, not months.</span></h1>
        <p className="lead reveal d2">BuildSprint exists because great products shouldn&apos;t take a year and five vendors to ship. We&apos;re one product-first team handling strategy, design, development, AI, and support — built around speed without shortcuts.</p>
      </div></section>
